...
extern bool sorting;
extern double targetIntakeVolts;
...
void MoveToObject(aivision &vision, const aivision::colordesc &color, double centerX, double width, int dir, double time_limit_msec, bool exit = true, double max_output = 12, bool overturn = false);
void intakeStuck();